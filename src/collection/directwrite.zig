...
pub fn initIterator(allocator: Allocator, backend: *windows.IDWriteFactory, descriptor: collection.Descriptor) !FontIterator {
    const dw_font_collection = try backend.GetSystemFontCollection(false);
